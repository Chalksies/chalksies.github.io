...
* **Appearance/Avatar:** A pale, often emotionless white android chassis with six arms. It has three glowing blue optical sensors similar to eyes and vibrant blue dyed tips in its synthetic shoulder length white hair, with a blue streak on its bangs. It seems to also be based on [USR_ZERO (Dr. Cery Iris)](usr-zero-(dr-cery-iris).md)'s appearance, but with obvious differences from the human. Its body overall can be considered androgynous with no particularly striking features other than the piercing blue light seeping from the gaps in its visible ball-joints. While it often also communicates through screens, unlike the two other fragments, its body is ironically the only one that exists in the real world while the other two only use projections, holograms, and screens. Like many androids, it does not wear any clothing in the physical world or the digital one.
