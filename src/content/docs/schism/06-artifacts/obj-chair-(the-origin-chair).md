...
* **Damage:** The headrest is scorched black from the heat of the neural-scan. The seat cushion is stained with the calcified dust of [USR_ZERO (Dr. Cery Iris)](../02-users/usr-zero-(dr-cery-iris).md)'s original body.
...
* *Rumor:* Null hackers believe that if someone physically sat in the chair and plugged in, they would gain Administrator access to the entire CHALKNET system. [SYS_EVOLVE (The Architect)](../02-users/sys-evolve-(the-architect).md) denies this claim.